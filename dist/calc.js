...
function sortedIndex(array, value) {
    ...
    while (low < high) {
        var mid = low + high >>> 1;
        if (parseFloat(array[mid][0]) < value)
            low = mid + 1;
        else
            high = mid;
    }
...
function getWalkingTime(x1, y1, x2, y2) {
    let y = x2 - x1;
    let x = y2 - y1;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            while (currentNode && searching && heap.length > 0) {
                ...
                let currentTime = (path === null || path === void 0 ? void 0 : path[0]) || Infinity;
                currentTime = parseFloat(currentTime);
                // last node is current node
                let currentNode = pee(path);
                ...
                if (currentNode in visited && currentTime > visited[currentNode])
                    continue;
