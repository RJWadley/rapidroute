...
function startNavigation(inRoute) {
    ...
    if ((firstRoute === null || firstRoute === void 0 ? void 0 : firstRoute.mode) == "MRT") {
        ...
        if (direction)
            direction += "bound";
        speakText("Proceed to " +
            firstPlace.id +
            ", " +
            ((_a = firstPlace.displayName) !== null && _a !== void 0 ? _a : firstPlace.longName));
        phrases.push({
            place: firstPlace.id,
            distance: 500,
            spoken: false,
        ...
        speakText("Proceed to " +
            firstPlace.id +
            ", " +
            ((_f = firstPlace.displayName) !== null && _f !== void 0 ? _f : firstPlace.longName));
    }
    route.forEach((placeId, i) => {
        ...
        if (i + 1 == route.length) {
            ...
            if (place.type == "MRT" &&
                route[i - 1].substr(0, 1) == route[i].substr(0, 1)) {
                ...
                phrases.push({
                    ...
                    phrase: "You have reached your destination, " +
                        place.id +
                        ", " +
                        ((_b = (_a = place.displayName) !== null && _a !== void 0 ? _a : place.longName) !== null && _b !== void 0 ? _b : ""),
                });
            }
        ...
        if (possibleRoutes.length == 0) {
            if (from.type == "MRT" && to.type == "MRT") {
                ...
                let phrase = "transfer to the " +
                    ...
                    nextPlace.id +
                    ", " +
                    ((_e = (_d = nextPlace.displayName) !== null && _d !== void 0 ? _d : nextPlace.longName) !== null && _e !== void 0 ? _e : "");
                phrases.push({
                    place: from.id,
                    distance: 1000,
                    spoken: false,
            ...
            if (from.type == "MRT" && to.type == "airport") {
                    ...
                    if (nextRoutes.length == 1) {
                        ...
                        then =
                            ", then take " +
                                ...
                                nextRoute.number +
                                ", to " +
                                ((_g = nextPlace.shortName) !== null && _g !== void 0 ? _g : "") +
                                ", " +
                        ...
                        then =
                            ", then take a flight to " +
                                ((_k = nextPlace.shortName) !== null && _k !== void 0 ? _k : "") +
                                ", " +
                ...
                let phrase = "walk to " +
                    ((_o = to.shortName) !== null && _o !== void 0 ? _o : "") +
                    ", " +
                    ((_p = to.displayName) !== null && _p !== void 0 ? _p : to.longName);
                phrases.push({
                    place: from.id,
                    distance: 1000,
                    spoken: false,
            ...
            if (from.type == "airport" && to.type == "airport") {
                    ...
                    if (nextRoutes.length == 1) {
                        ...
                        then =
                            "take " +
                                ...
                                nextRoute.number +
                                ", to " +
                                ((_r = nextPlace.shortName) !== null && _r !== void 0 ? _r : "") +
                                ", " +
                        ...
                        then =
                            "take a flight to " +
                                ((_u = nextPlace.shortName) !== null && _u !== void 0 ? _u : "") +
                                ", " +
                ...
                let phrase = "Welcome to " +
                    ((_y = (_x = to.displayName) !== null && _x !== void 0 ? _x : to.longName) !== null && _y !== void 0 ? _y : to.shortName) +
                    "... ";
                phrases.push({
                    place: from.id,
                    distance: -1,
