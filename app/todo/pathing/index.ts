import type { DataType, ExcludedRoutes, Place } from "app/todo/data"
import { type Coordinate, parseCoordinateId } from "app/todo/data/coordinates"
import { placesMatch } from "app/todo/data/placesMatch"
import { getCompressedPlaces } from "app/todo/utils/compressedPlaces"
import { findClosestPlace } from "app/todo/utils/search"
